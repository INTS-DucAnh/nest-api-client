...
export default function DialogDeleteTag({ tag, trigger, onSuccess }: { tag?: TagFindItemType; trigger: ReactNode; onSuccess: () => void }) {
  ...
  return (
    <DialogComponent trigger={trigger} title='Delete this tag' description='By confirm this action will delete this tag.'>
      <DialogFooter>
        <DialogClose>
