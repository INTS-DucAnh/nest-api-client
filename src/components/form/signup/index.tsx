                ...
                return(
                  <RenderFormItem label="Date" require>
                    ...
                    >
                      ...
                      <SelectContent>
                        {dayCount.map((day, id) => {
                          return <SelectItem value={(id+1).toString()} key={id+1}>{id+1}</SelectItem>
                        })}
                      </SelectContent>
                    </Select>                      
                  </RenderFormItem>
                ...
                return(
                  <RenderFormItem label="Year" require>
                    ...
                    >
                      ...
                      <SelectContent>
                        {yearCount.map((_, id) => {
                          return <SelectItem value={(currentYear - id - 1).toString()} key={currentYear - id - 1}>{currentYear - id - 1}</SelectItem>
                        })}
                      </SelectContent>
                    </Select> 
                  </RenderFormItem>
